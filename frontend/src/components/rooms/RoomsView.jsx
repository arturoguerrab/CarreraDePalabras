...
const RoomsView = ({
	...
	return (
		<div className="min-h-screen bg-retro-bg flex items-center justify-center px-4 py-12 font-arcade relative overflow-hidden">
			...
			{/* Decoración */}
			<div className="absolute top-16 left-16 w-12 h-12 bg-retro-yellow-bright border-4 border-black shadow-retro-sm transform rotate-12"></div>
			<div className="absolute bottom-16 right-16 w-8 h-24 bg-retro-pink-light border-4 border-black shadow-retro-sm transform -rotate-6"></div>

			<div className="w-full max-w-md relative z-10">
				<div className="bg-white border-4 border-black shadow-retro rounded-3xl p-8 relative text-center">
					<h1 className="text-2xl text-black mb-2 uppercase font-bold tracking-tighter">
						JUGAR
					</h1>
					<p className="text-[10px] text-gray-400 mb-10 uppercase tracking-widest leading-loose">
						¿Nueva sala o unirse a una?
					</p>
					...
					<div className="space-y-8">
						...
						<button
							...
							className="w-full py-5 bg-retro-yellow border-4 border-black text-black text-[10px] uppercase hover:bg-yellow-300 rounded-xl shadow-retro hover:translate-y-1 hover:shadow-retro-sm transition-all font-bold"
						>
							Crear Sala
						</button>
						...
						<div className="relative flex py-2 items-center">
							<div className="grow border-t-4 border-black border-dashed opacity-20"></div>
							<span className="shrink-0 mx-4 text-black text-[8px] uppercase font-bold opacity-30">
								O únete por código
							</span>
							<div className="grow border-t-4 border-black border-dashed opacity-20"></div>
						</div>
						...
						<form onSubmit={handleJoinRoom} className="space-y-5">
							...
							<button
								type="submit"
								className="w-full py-5 bg-retro-blue border-4 border-black text-white text-[10px] uppercase hover:bg-blue-500 rounded-xl shadow-retro hover:translate-y-1 hover:shadow-retro-sm transition-all font-bold mt-4"
							>
								Entrar
							</button>
						</form>
