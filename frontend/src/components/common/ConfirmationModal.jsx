...
/**
 * CONFIRMATION MODAL
 * Un modal con estética retro-arcade para confirmar acciones críticas.
 */
const ConfirmationModal = ({ 
  ...
  cancelText = "VOLVER",
  confirmColor = "bg-[#ef4444]", // Rojo por defecto para salir
}) => {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      {/* Modal Card */}
      <div className="bg-white border-4 border-black shadow-[12px_12px_0px_0px_rgba(0,0,0,0.3)] rounded-3xl p-8 max-w-sm w-full relative z-10 animate-in zoom-in-95 duration-200 text-center font-['Press_Start_2P']">
        ...
        <div className="space-y-4">
          ...
          <button
            onClick={onCancel}
            className="w-full py-4 bg-white border-4 border-black text-black text-[10px] uppercase hover:bg-gray-100 rounded-xl shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:translate-y-1 hover:shadow-none transition-all font-bold"
          >
            {cancelText}
          </button>
        </div>
